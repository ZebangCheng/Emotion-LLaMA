...
- **Batch CLI** - Resumable CSV/JSONL, single-video, and directory inference
...
For offline terminal inference, see the [Batch Inference guide](batch-inference.md).
...
- Run resumable terminal jobs with [Batch Inference](batch-inference.md)
